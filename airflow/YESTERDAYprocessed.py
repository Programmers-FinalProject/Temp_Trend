#전날 데이터와 비교하여 달라진 카테고리가 있으면 알람을 보내는!
...
with DAG(
    dag_id='YESTERDAY_s3_data_preprocessing_and_upload',
    ...
    def preprocess_data():
        ...
        seoul_now = datetime.now(seoul_tz) - timedelta(days=2)
    ...
    upload_df_to_s3(data,"df2", f'model/file29/df2_{today}.csv')
    upload_df_to_s3(data,"df_full", f'model/full29_processed/df_full_{today}.csv')
