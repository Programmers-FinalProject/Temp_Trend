...
def fetch_data():
    ...
    category_list = ['272103100','272104100','272102100','272110100','272112100','272105100'
                '272111100','272113100','272109100',]
...
dag = DAG(
    ...
    description='Collect male clothes data of 29cm',
    schedule_interval='15 10 * * *', # 매일 저녁 19시 15분 ( utc 기준 실행 )
    catchup = False
)

fetch_task = PythonOperator(
    task_id='29cm_male_clothes_gathering',
